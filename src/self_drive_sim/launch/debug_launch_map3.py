...
WORLD_NAME = 'map3.world'
FLOORMAP_NAME = 'map3.npz'
POLLUTION_NAME = 'map3.json'
INIT_POS = (-7.0, 5.0, 0.0, 0.0) # x, y, z, Y
ACTORS = [
    {'actor_name': 'actor1', 'collision_name': 'actor1_collision'},
    {'actor_name': 'actor2', 'collision_name': 'actor2_collision'},
]
...
def generate_launch_description():
    ...
    teleop_node = Node(
        ...
        output='screen',
        prefix='gnome-terminal -- ros2 run teleop_twist_keyboard teleop_twist_keyboard',
        remappings=[
